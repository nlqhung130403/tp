...
with(this){return _c('ol',[_c('li',[_v("When "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" is called upon to execute a command, it is passed to an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" object which in turn creates a parser that matches the command (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommandParser")]),_v(") and uses it to parse the command.")]),_v(" "),_c('li',[_v("This results in a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" object (more precisely, an object of one of its subclasses e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommand")]),_v(") which is then executed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(".")]),_v(" "),_c('li',[_v("During execution, the command may interact with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" to perform necessary operations (e.g. deleting a client). While this is shown as a single step in the diagram above for simplicity, it often involves multiple method calls between the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(".")]),_v(" "),_c('li',[_v("The result of the command execution is encapsulated in a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" object which is returned from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Internally, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" also handles logging and error tracking through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogsCenter")]),_v(" utility. This enables detailed logs for actions such as the input command string and any exceptions thrown during parsing or execution, providing transparency and easing debugging.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component is designed with extensibility in mind. To support a new command, developers simply need to:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Implement a new subclass of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SortCommand")]),_v(")")]),_v(" "),_c('li',[_v("Create a matching parser (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SortCommandParser")]),_v(") that implements the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser<T>")]),_v(" interface")]),_v(" "),_c('li',[_v("Add a corresponding "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("case")]),_v(" to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser#parseCommand")]),_v(" method")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"rank-feature"}},[_v("Rank feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#rank-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"command-architecture"}},[_v("Command Architecture"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#command-architecture","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Rank")]),_v(" command component,")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("holds a client "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Comparator")]),_v(" that determines the sort order between any two clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("compare")]),_v(" method.")]),_v(" "),_c('li',[_v("each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Comparator")]),_v(" has a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("COMPARATOR_WORD")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("String")]),_v(" that is used to parse user input to create the suitable "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Comparator")]),_v(".")]),_v(" "),_c('li',[_v("each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Comparator")]),_v(" also depends on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Client")]),_v(" which helps to gain access to the required parameters to compare with.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("The user launches the application, and decides that they want to see "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Alice")]),_v(" at the top of their client list.")]),_v(" "),_c('li',[_v("They would simply have to type "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rank name")]),_v(" as the command input.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Here's the sequence diagram that shows the flow of the execution for the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rank name")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("salespeople who wish to know their users' preferences better")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": provide fast access to clients’ addresses and preferences to help salespeople in making sales decisions and building rapports with clients, which can potentially increase their sales revenue")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("add in my clients’ contact details")]),_v(" "),_c('td',[_v("contact them for business purposes")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("edit my clients’ contact details")]),_v(" "),_c('td',[_v("keep their information updated and relevant")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("delete a client")]),_v(" "),_c('td',[_v("get rid of contact information that I don’t need anymore")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("find my clients’ info quickly in a large database")]),_v(" "),_c('td',[_v("locate contact details of clients without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("salesclient who wants to know my customer preferences")]),_v(" "),_c('td',[_v("rank my clients based on the most purchased product type")]),_v(" "),_c('td',[_v("find out who my potential customers are for a given product")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("keep track on clients' frequency of purchase")]),_v(" "),_c('td',[_v("clientalise advertisement and services")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("keep track of clients' product preferences")]),_v(" "),_c('td',[_v("promote new products to clients that are more likely to be interested in")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("view examples for the main features")]),_v(" "),_c('td',[_v("get on board with the application more easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("be able to expand out the client information")]),_v(" "),_c('td',[_v("view it with a bigger window")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("undo all my previously executed commands")]),_v(" "),_c('td',[_v("revert changes without having to manually type in a long command")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("search for clients by name, phone number, or tag")]),_v(" "),_c('td',[_v("quickly retrieve their information without scrolling through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("add profile pictures for my clients")]),_v(" "),_c('td',[_v("quickly recognize them and clientalize my interactions")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("add social media links to client profiles")]),_v(" "),_c('td',[_v("easily connect with them on different platforms")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("salesclient whose clients are of different statuses")]),_v(" "),_c('td',[_v("categorize clients into different groups (e.g., VIP, Potential, Regular)")]),_v(" "),_c('td',[_v("manage them more efficiently and tailor my communication")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("salesclient whose customers come from many industries")]),_v(" "),_c('td',[_v("add tags for clients")]),_v(" "),_c('td',[_v("split them into categories")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("filter clients by tags")]),_v(" "),_c('td',[_v("quickly see all the clients inside one category")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("be able to use the software in dark mode")]),_v(" "),_c('td',[_v("view the contents comfortably")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("have multiple accounts")]),_v(" "),_c('td',[_v("save customer profiles for different businesses")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("salesclient who needs to report to my company")]),_v(" "),_c('td',[_v("export my client list to a CSV file")]),_v(" "),_c('td',[_v("share it with my team or use it for data analysis and reporting")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("salesclient")]),_v(" "),_c('td',[_v("track the geographical location of my clients")]),_v(" "),_c('td',[_v("plan visits efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("paranoid user")]),_v(" "),_c('td',[_v("access my address book via an authentication system")]),_v(" "),_c('td',[_v("my customer profiles are kept confidential")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("use the software in my desired language")]),_v(" "),_c('td',[_v("understand how to use the software better")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClientConnect")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the command to add a client.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect validates the input format and checks that all required fields are present.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect adds the client to the address book.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect displays a confirmation message showing the newly added contact details.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. Invalid Field Detected:")]),_v(" "),_c('ul',[_c('li',[_v("2a1. If ClientConnect detects a missing or incorrectly formatted field, it displays an error message.")]),_v(" "),_c('li',[_v("2a2. User re-enters the correct information.")]),_v(" "),_c('li',[_v("2a3. ClientConnect re-validates the updated input and proceeds from step 2 once the error is resolved.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View List of Clients")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the command to view current list of added entities")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect validates the command input.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect retrieves all stored entities from the address book.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect displays the list with each entity’s name, contact number, and address in a clear, formatted view.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a: If the command input is not recognized (e.g., due to a typo), ClientConnect displays: “I do not understand your command, please try again.”")]),_v(" "),_c('li',[_v("3a: If no entities are found (i.e., the address book is empty), ClientConnect displays the message: “Your list is empty.”")])])}
},function anonymous(
) {
...
with(this){return _c('li',[_c('p',[_v("User enters the command to view the list of clients.")])])}
},function anonymous(
) {
with(this){return _c('li',[_c('p',[_v("ClientConnect displays the full list of clients.")])])}
},function anonymous(
) {
with(this){return _c('li',[_c('p',[_v("User enters the command to delete a client.")])])}
},function anonymous(
) {
with(this){return _c('li',[_c('p',[_v("ClientConnect validates the command.")])])}
},function anonymous(
) {
with(this){return _c('li',[_c('p',[_v("ClientConnect retrieves the details of the client at the specified index.")])])}
},function anonymous(
) {
with(this){return _c('li',[_c('p',[_v("ClientConnect deletes the client's details from the address book.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the command to find a list of clients that contains the keyword.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect validates the command.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect retrieves the information of clients that contains that specified keyword in their descriptions.")])]),_v(" "),_c('li',[_c('p',[_v("ClientConnect displays the list of clients.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Client")]),_v(": The customers who the salesclient (also user of this application) is selling products to.")]),_v(" "),_c('li',[_c('strong',[_v("Command")]),_v(": A one-line instruction typed into the application by user.")]),_v(" "),_c('li',[_c('strong',[_v("Contact detail")]),_v(": Including contact names, phone numbers, adresses and optionally tags, etc.")]),_v(" "),_c('li',[_c('strong',[_v("CSV file")]),_v(": Comma-separated values, a plain text file format that stores data in a table-like structure. Can be opened using Microsoft Excel or be imported to other supported applications.")]),_v(" "),_c('li',[_c('strong',[_v("Main features")]),_v(": The main features of this application, including "),_c('em',[_v("list")]),_v(", "),_c('em',[_v("add")]),_v(", "),_c('em',[_v("delete")]),_v(", etc.")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Salesclient")]),_v(": Anyone who is selling things and has the need to note down clients' information.")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Product Preference")]),_v(": A specific product or category of products that a client is interested in.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('em',[_v("Team size: 5")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Support multiple product preferences for each client")]),_v(": The current client only has one product preference and its frequency. We plan to make every client has a list of product preferences with its corresponding frequency, to meet a more realistic scenario.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("New commands to work with product preference")]),_v(": Once we have multiple product preferences for each client, we would also like to add a command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddProductPreference")]),_v(" to add product preferences cumulatively for one client, and a command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteProductPreference")]),_v(" to delete a certain product preference and its frequency for one client.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("New commands to add tags cumulatively")]),_v(": For the same reason, now we can only edit tags through "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(" command, and if we want to add a new tag to a client without touching existing tags, we will also have to type out all the existing tags in the command, which is very inconvenient and unpractical. We can add new command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddTag")]),_v(" to add new tags cumulatively to a client, and another new command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteTag")]),_v(" to delete a certain existing tag for a client.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Rank clients by product frequency of a certain product preference")]),_v(": We want our "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rank")]),_v(" command to be more useful, adding it's ability to rank in many ways, including rank clients based on the frequency of a certain product.")])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 23:00:47 GMT+8]")])])])}
}];
