...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new seedu.address.testutil.EditClientDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new seedu.address.testutil.EditClientDescriptorBuilder().withName(VALID_NAME_BOB)
