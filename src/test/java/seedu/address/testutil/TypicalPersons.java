...
public class TypicalPersons {
    ...
    public static final Client ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("19482224")
            .withEmail("werner@example.com").withAddress("michegan ave").build();
    public static final Client FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("19482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").build();
    public static final Client GEORGE = new PersonBuilder().withName("George Best").withPhone("19482442")
            .withEmail("anna@example.com").withAddress("4th street").build();

    // Manually added
    public static final Client HOON = new PersonBuilder().withName("Hoon Meier").withPhone("84827424")
            .withEmail("stefan@example.com").withAddress("little india").build();
    public static final Client IDA = new PersonBuilder().withName("Ida Mueller").withPhone("84872131")
